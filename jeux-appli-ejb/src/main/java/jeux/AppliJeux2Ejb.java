...
public class AppliJeux2Ejb extends Application {

	// Titre de la fenêtre
	private final String TITRE = "Jeux EJB";
	...
	public final void start(Stage stage) {
		...
		try {
			...
			context.register(Config3Ejb.class);
			context.refresh();
	...
	public static class Main {
		public static void main(String[] args) {
			Application.launch(AppliJeux2Ejb.class, args);
			System.exit(0);
		}
	}
	...
	private static Logger getLogger() {
		try {
			InputStream in = AppliJeux2Ejb.class.getResourceAsStream("/META-INF/logging.properties");
		...
		return Logger.getLogger(AppliJeux2Ejb.class.getName());
	}
